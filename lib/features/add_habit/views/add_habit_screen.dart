          ...
          children: [
            ...
            AppButton(
              ...
              onPressed: () {
                ...
                if (habitTitle.isEmpty) return; // Quick validation

                final newHabit = Habit(
                  id: '',
                  // Usually generated by the backend, but required by your constructor
                  title: habitTitle,
                  goal: 1,
                  frequency: 'daily',
                  // Provide a default or get from a dropdown
                  color: '#4CAF50',
                  icon: 'check',
                  isDone: false,
                  streak: 0,
